...
if($step==3){
    if($_GET['jump']==1){
        ...
        $config="<?php\n/* Database configuration. Generated by the installer. */\n\$dbconfig = ".var_export($dbconfig, true).";\n";
    }
    if(empty($errorMsg)){
        try{
    ...
    if(!$dbconfig['user']||!$dbconfig['pwd']||!$dbconfig['dbname']) {
        ...
        if(empty($errorMsg) && !$_GET['jump']){
            ...
            $sqls=explode(';', $sqls);
			$initialAdminPassword = pan_random_string(20);
			$initialAdminPasswordHash = password_hash($initialAdminPassword, PASSWORD_DEFAULT);
			$sqls[]="REPLACE INTO `pre_config` VALUES ('admin_pwd', '".$initialAdminPasswordHash."')";
			$sqls[]="INSERT INTO `pre_config` VALUES ('syskey', '".pan_random_string(64)."')";
			$sqls[]="REPLACE INTO `pre_config` VALUES ('api_token', '".pan_random_string(48)."')";
...
<head>
    ...
    <title>LinkNest 外链云盘 - 安装程序</title>
...
<div class="container"><br>
    <div class="row">
        <div class="col-xs-12 col-sm-10 col-md-8 center-block" style="float: none;">
            <pre><h4>LinkNest 外链云盘 - 安装程序</h4></pre>
...
?>
                <div class="list-group-item list-group-item-info text-center">系统检测到你已安装过 LinkNest 或其兼容旧版本</div>
...
?>
                ...
                <div class="panel-body">
                    ...
                    <ul class="list-group">
						...
						<?php if(!empty($initialAdminPassword)){?><li class="list-group-item">2、后台地址：<a href="../admin/" target="_blank">/admin/</a> 用户名：admin 密码:<?php echo htmlspecialchars($initialAdminPassword, ENT_QUOTES, 'UTF-8');?></li>
                        <li class="list-group-item">3、请立即将管理员密码保存到密码管理器，并在首次登录后按需要修改。</li><?php }else{?><li class="list-group-item">2、已保留现有站点数据和管理员账号。</li><?php }?>
                ...
                <div class="panel-body">
                    ...
                    if(is_writable($databaseFile) || is_writable(dirname($databaseFile))) {
            ...
            <footer class="footer">
            <pre><center>LinkNest · 基于 <a href="https://github.com/netcccyun/pan" rel="noreferrer" target="_blank">netcccyun/pan</a> 开源维护</center></pre>
            </footer>
        </div>
    </div>
</div>
